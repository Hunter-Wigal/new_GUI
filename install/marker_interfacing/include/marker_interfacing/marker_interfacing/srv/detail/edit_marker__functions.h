...
#ifndef MARKER_INTERFACING__SRV__DETAIL__EDIT_MARKER__FUNCTIONS_H_
#define MARKER_INTERFACING__SRV__DETAIL__EDIT_MARKER__FUNCTIONS_H_
...
/// Initialize srv/EditMarker message.
/**
...
/// Finalize srv/EditMarker message.
/**
...
/// Create srv/EditMarker message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * marker_interfacing__srv__EditMarker_Request__init().
...
/// Destroy srv/EditMarker message.
/**
 * It calls
 * marker_interfacing__srv__EditMarker_Request__fini()
...
/// Check for srv/EditMarker message equality.
/**
...
/// Initialize array of srv/EditMarker messages.
/**
...
/// Finalize array of srv/EditMarker messages.
/**
 * It calls
 * marker_interfacing__srv__EditMarker_Request__fini()
...
/// Create array of srv/EditMarker messages.
/**
 * It allocates the memory for the array and calls
 * marker_interfacing__srv__EditMarker_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/EditMarker messages.
/**
 * It calls
 * marker_interfacing__srv__EditMarker_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/EditMarker message array equality.
/**
...
/// Copy an array of srv/EditMarker messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * marker_interfacing__srv__EditMarker_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_marker_interfacing
...
/**
 * It calls
 * marker_interfacing__srv__EditMarker_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_marker_interfacing
...
/**
 * It allocates the memory for the array and calls
 * marker_interfacing__srv__EditMarker_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_marker_interfacing
...
/**
 * It calls
 * marker_interfacing__srv__EditMarker_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MARKER_INTERFACING__SRV__DETAIL__EDIT_MARKER__FUNCTIONS_H_
