...
bool marker_interfacing__srv__add_marker__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marker_interfacing.srv._add_marker.AddMarker_Request", full_classname_dest, 52) == 0);
  }
  marker_interfacing__srv__AddMarker_Request * ros_message = _ros_message;
  {  // lat
...
{
  /* NOTE(esteve): Call constructor of AddMarker_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marker_interfacing.srv._add_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AddMarker_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool marker_interfacing__srv__add_marker__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marker_interfacing.srv._add_marker.AddMarker_Response", full_classname_dest, 53) == 0);
  }
  marker_interfacing__srv__AddMarker_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of AddMarker_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marker_interfacing.srv._add_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AddMarker_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
