...
bool marker_interfacing__msg__enu_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marker_interfacing.msg._enu_marker.ENUMarker", full_classname_dest, 44) == 0);
  }
  marker_interfacing__msg__ENUMarker * ros_message = _ros_message;
  {  // waypoint_enu
    PyObject * field = PyObject_GetAttrString(_pymsg, "waypoint_enu");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->waypoint_enu)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ENUMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marker_interfacing.msg._enu_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ENUMarker");
  ...
  {  // waypoint_enu
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->waypoint_enu);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "waypoint_enu", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
