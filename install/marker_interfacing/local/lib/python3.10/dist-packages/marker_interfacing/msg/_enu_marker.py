...
class Metaclass_ENUMarker(type):
    """Metaclass of message 'ENUMarker'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'marker_interfacing.msg.ENUMarker')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__enu_marker
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__enu_marker
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__enu_marker
            cls._TYPE_SUPPORT = module.type_support_msg__msg__enu_marker
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__enu_marker
...
class ENUMarker(metaclass=Metaclass_ENUMarker):
    """Message class 'ENUMarker'."""
    ...
    _fields_and_field_types = {
        'waypoint_enu': 'geometry_msgs/Point',
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Point
        self.waypoint_enu = kwargs.get('waypoint_enu', Point())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.waypoint_enu != other.waypoint_enu:
            return False
    ...
    @builtins.property
    def waypoint_enu(self):
        """Message field 'waypoint_enu'."""
        return self._waypoint_enu

    @waypoint_enu.setter
    def waypoint_enu(self, value):
        if __debug__:
            from geometry_msgs.msg import Point
            assert \
                isinstance(value, Point), \
                "The 'waypoint_enu' field must be a sub message of type 'Point'"
        self._waypoint_enu = value
