...
class Metaclass_Resolution(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from theora_webcams.msg import Framerate
            if Framerate.__class__._TYPE_SUPPORT is None:
                Framerate.__class__.__import_type_support__()
...
class Resolution(metaclass=Metaclass_Resolution):
    ...
    _fields_and_field_types = {
        'width': 'int32',
        'height': 'int32',
        'framerates': 'sequence<theora_webcams/Framerate>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['theora_webcams', 'msg'], 'Framerate')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.framerates = kwargs.get('framerates', [])
    ...
    def __eq__(self, other):
        ...
        if self.height != other.height:
            return False
        if self.framerates != other.framerates:
            return False
        return True
    ...
    @builtins.property
    def framerates(self):
        """Message field 'framerates'."""
        return self._framerates

    @framerates.setter
    def framerates(self, value):
        if __debug__:
            from theora_webcams.msg import Framerate
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Framerate) for v in value) and
                 True), \
                "The 'framerates' field must be a set or sequence and each value of type 'Framerate'"
        self._framerates = value
