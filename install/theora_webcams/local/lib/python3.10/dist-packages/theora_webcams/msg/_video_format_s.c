...
bool theora_webcams__msg__video_format__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("theora_webcams.msg._video_format.VideoFormat", full_classname_dest, 44) == 0);
  }
  theora_webcams__msg__VideoFormat * ros_message = _ros_message;
  {  // format
...
{
  /* NOTE(esteve): Call constructor of VideoFormat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("theora_webcams.msg._video_format");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VideoFormat");
