...
#include "theora_webcams/srv/detail/get_exposure_bounds__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const theora_webcams::srv::GetExposureBounds_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<theora_webcams::srv::GetExposureBounds_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetExposureBounds_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const theora_webcams::srv::GetExposureBounds_Request *>(
...
static size_t _GetExposureBounds_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetExposureBounds_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetExposureBounds_Request__callbacks = {
  "theora_webcams::srv",
...
static rosidl_message_type_support_t _GetExposureBounds_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetExposureBounds_Request__callbacks,
...
{
  return &theora_webcams::srv::typesupport_fastrtps_cpp::_GetExposureBounds_Request__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.exposure_bounds;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: exposure_bounds
  {
    ...
    size_t item_size = sizeof(ros_message.exposure_bounds[0]);
...
{
  auto typed_message =
    static_cast<const theora_webcams::srv::GetExposureBounds_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<theora_webcams::srv::GetExposureBounds_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetExposureBounds_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const theora_webcams::srv::GetExposureBounds_Response *>(
...
static size_t _GetExposureBounds_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetExposureBounds_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetExposureBounds_Response__callbacks = {
  "theora_webcams::srv",
...
static rosidl_message_type_support_t _GetExposureBounds_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetExposureBounds_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &theora_webcams::srv::typesupport_fastrtps_cpp::_GetExposureBounds_Response__handle;
}
...
static service_type_support_callbacks_t _GetExposureBounds__callbacks = {
  "theora_webcams::srv",
  "GetExposureBounds",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, theora_webcams, srv, GetExposureBounds_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, theora_webcams, srv, GetExposureBounds_Response)(),
...
static rosidl_service_type_support_t _GetExposureBounds__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetExposureBounds__callbacks,
...
{
  return &theora_webcams::srv::typesupport_fastrtps_cpp::_GetExposureBounds__handle;
}
