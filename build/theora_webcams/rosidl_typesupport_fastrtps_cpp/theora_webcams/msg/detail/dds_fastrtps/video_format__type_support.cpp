...
#include "theora_webcams/msg/detail/video_format__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const theora_webcams::msg::VideoFormat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  theora_webcams::msg::VideoFormat & ros_message)
{
  // Member: format
  cdr >> ros_message.format;
...
{
  auto typed_message =
    static_cast<const theora_webcams::msg::VideoFormat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<theora_webcams::msg::VideoFormat *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VideoFormat__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const theora_webcams::msg::VideoFormat *>(
...
static size_t _VideoFormat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VideoFormat(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VideoFormat__callbacks = {
  "theora_webcams::msg",
  "VideoFormat",
...
static rosidl_message_type_support_t _VideoFormat__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VideoFormat__callbacks,
...
{
  return &theora_webcams::msg::typesupport_fastrtps_cpp::_VideoFormat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, theora_webcams, msg, VideoFormat)() {
  return &theora_webcams::msg::typesupport_fastrtps_cpp::_VideoFormat__handle;
}
