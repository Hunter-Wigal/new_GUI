...
static const _SetExposure_Request_type_support_symbol_names_t _SetExposure_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, theora_webcams, srv, SetExposure_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, theora_webcams, srv, SetExposure_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, theora_webcams, srv, SetExposure_Request)() {
  return &::theora_webcams::srv::rosidl_typesupport_c::SetExposure_Request_message_type_support_handle;
}
...
static const _SetExposure_Response_type_support_symbol_names_t _SetExposure_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, theora_webcams, srv, SetExposure_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, theora_webcams, srv, SetExposure_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, theora_webcams, srv, SetExposure_Response)() {
  return &::theora_webcams::srv::rosidl_typesupport_c::SetExposure_Response_message_type_support_handle;
}
...
static const _SetExposure_type_support_symbol_names_t _SetExposure_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, theora_webcams, srv, SetExposure)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, theora_webcams, srv, SetExposure)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, theora_webcams, srv, SetExposure)() {
  return &::theora_webcams::srv::rosidl_typesupport_c::SetExposure_service_type_support_handle;
}
