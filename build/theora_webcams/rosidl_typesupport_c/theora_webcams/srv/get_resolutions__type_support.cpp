...
static const _GetResolutions_Request_type_support_symbol_names_t _GetResolutions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, theora_webcams, srv, GetResolutions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, theora_webcams, srv, GetResolutions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, theora_webcams, srv, GetResolutions_Request)() {
  return &::theora_webcams::srv::rosidl_typesupport_c::GetResolutions_Request_message_type_support_handle;
}
...
static const _GetResolutions_Response_type_support_symbol_names_t _GetResolutions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, theora_webcams, srv, GetResolutions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, theora_webcams, srv, GetResolutions_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, theora_webcams, srv, GetResolutions_Response)() {
  return &::theora_webcams::srv::rosidl_typesupport_c::GetResolutions_Response_message_type_support_handle;
}
...
static const _GetResolutions_type_support_symbol_names_t _GetResolutions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, theora_webcams, srv, GetResolutions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, theora_webcams, srv, GetResolutions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, theora_webcams, srv, GetResolutions)() {
  return &::theora_webcams::srv::rosidl_typesupport_c::GetResolutions_service_type_support_handle;
}
