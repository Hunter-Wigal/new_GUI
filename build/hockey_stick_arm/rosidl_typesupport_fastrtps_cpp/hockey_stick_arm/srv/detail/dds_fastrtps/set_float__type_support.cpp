...
#include "hockey_stick_arm/srv/detail/set_float__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const hockey_stick_arm::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hockey_stick_arm::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  return &hockey_stick_arm::srv::typesupport_fastrtps_cpp::_SetFloat_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const hockey_stick_arm::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hockey_stick_arm::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hockey_stick_arm::srv::typesupport_fastrtps_cpp::_SetFloat_Response__handle;
}
...
{
  return &hockey_stick_arm::srv::typesupport_fastrtps_cpp::_SetFloat__handle;
}
