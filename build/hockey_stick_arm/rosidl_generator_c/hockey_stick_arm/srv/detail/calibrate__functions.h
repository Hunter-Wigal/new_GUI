...
#ifndef HOCKEY_STICK_ARM__SRV__DETAIL__CALIBRATE__FUNCTIONS_H_
#define HOCKEY_STICK_ARM__SRV__DETAIL__CALIBRATE__FUNCTIONS_H_
 ...
 * calls
 * hockey_stick_arm__srv__Calibrate_Request__init().
...
/**
 * It calls
 * hockey_stick_arm__srv__Calibrate_Request__fini()
 ...
 * hockey_stick_arm__srv__Calibrate_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hockey_stick_arm__srv__Calibrate_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hockey_stick_arm__srv__Calibrate_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hockey_stick_arm
...
/**
 * It calls
 * hockey_stick_arm__srv__Calibrate_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hockey_stick_arm
...
/**
 * It allocates the memory for the array and calls
 * hockey_stick_arm__srv__Calibrate_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hockey_stick_arm
...
/**
 * It calls
 * hockey_stick_arm__srv__Calibrate_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HOCKEY_STICK_ARM__SRV__DETAIL__CALIBRATE__FUNCTIONS_H_
