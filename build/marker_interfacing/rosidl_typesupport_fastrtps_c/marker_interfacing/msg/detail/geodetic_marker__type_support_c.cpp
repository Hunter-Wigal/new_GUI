...
#include "marker_interfacing/msg/detail/geodetic_marker__rosidl_typesupport_fastrtps_c.h"
...
#include "geographic_msgs/msg/detail/geo_point__functions.h"  // gps
...
using _GeodeticMarker__ros_msg_type = marker_interfacing__msg__GeodeticMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GeodeticMarker__ros_msg_type * ros_message = static_cast<const _GeodeticMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: gps
  {
  ...
  void * untyped_ros_message)
{
  ...
  _GeodeticMarker__ros_msg_type * ros_message = static_cast<_GeodeticMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: gps
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _GeodeticMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_marker_interfacing__msg__GeodeticMarker(
...
static size_t _GeodeticMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_marker_interfacing__msg__GeodeticMarker(
...
static message_type_support_callbacks_t __callbacks_GeodeticMarker = {
...
static rosidl_message_type_support_t _GeodeticMarker__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GeodeticMarker,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marker_interfacing, msg, GeodeticMarker)() {
  return &_GeodeticMarker__type_support;
}
