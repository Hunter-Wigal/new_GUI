...
static const _AddMarker_Request_type_support_symbol_names_t _AddMarker_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marker_interfacing, srv, AddMarker_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marker_interfacing, srv, AddMarker_Request)),
  }
};
...
{
  return &::marker_interfacing::srv::rosidl_typesupport_cpp::AddMarker_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, marker_interfacing, srv, AddMarker_Request)() {
  return get_message_type_support_handle<marker_interfacing::srv::AddMarker_Request>();
}
...
static const _AddMarker_Response_type_support_symbol_names_t _AddMarker_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marker_interfacing, srv, AddMarker_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marker_interfacing, srv, AddMarker_Response)),
  }
};
...
{
  return &::marker_interfacing::srv::rosidl_typesupport_cpp::AddMarker_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, marker_interfacing, srv, AddMarker_Response)() {
  return get_message_type_support_handle<marker_interfacing::srv::AddMarker_Response>();
}
...
static const _AddMarker_type_support_symbol_names_t _AddMarker_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marker_interfacing, srv, AddMarker)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marker_interfacing, srv, AddMarker)),
  }
};
...
{
  return &::marker_interfacing::srv::rosidl_typesupport_cpp::AddMarker_service_type_support_handle;
}
