...
static const _GeodeticMarker_type_support_symbol_names_t _GeodeticMarker_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marker_interfacing, msg, GeodeticMarker)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marker_interfacing, msg, GeodeticMarker)),
  }
};
...
{
  return &::marker_interfacing::msg::rosidl_typesupport_cpp::GeodeticMarker_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, marker_interfacing, msg, GeodeticMarker)() {
  return get_message_type_support_handle<marker_interfacing::msg::GeodeticMarker>();
}
