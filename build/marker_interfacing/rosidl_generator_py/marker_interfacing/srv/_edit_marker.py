...
class Metaclass_EditMarker_Request(type):
    """Metaclass of message 'EditMarker_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__edit_marker__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__edit_marker__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__edit_marker__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__edit_marker__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__edit_marker__request
...
class EditMarker_Request(metaclass=Metaclass_EditMarker_Request):
    """Message class 'EditMarker_Request'."""
...
class Metaclass_EditMarker_Response(type):
    """Metaclass of message 'EditMarker_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__edit_marker__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__edit_marker__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__edit_marker__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__edit_marker__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__edit_marker__response
...
class EditMarker_Response(metaclass=Metaclass_EditMarker_Response):
    """Message class 'EditMarker_Response'."""
...
class Metaclass_EditMarker(type):
    """Metaclass of service 'EditMarker'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'marker_interfacing.srv.EditMarker')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__edit_marker

            from marker_interfacing.srv import _edit_marker
            if _edit_marker.Metaclass_EditMarker_Request._TYPE_SUPPORT is None:
                _edit_marker.Metaclass_EditMarker_Request.__import_type_support__()
            if _edit_marker.Metaclass_EditMarker_Response._TYPE_SUPPORT is None:
                _edit_marker.Metaclass_EditMarker_Response.__import_type_support__()


class EditMarker(metaclass=Metaclass_EditMarker):
    from marker_interfacing.srv._edit_marker import EditMarker_Request as Request
    from marker_interfacing.srv._edit_marker import EditMarker_Response as Response
