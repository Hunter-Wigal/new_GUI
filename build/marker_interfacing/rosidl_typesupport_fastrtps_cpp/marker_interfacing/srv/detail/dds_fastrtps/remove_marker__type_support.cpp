...
#include "marker_interfacing/srv/detail/remove_marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const marker_interfacing::srv::RemoveMarker_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<marker_interfacing::srv::RemoveMarker_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RemoveMarker_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const marker_interfacing::srv::RemoveMarker_Request *>(
...
static size_t _RemoveMarker_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RemoveMarker_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RemoveMarker_Request__callbacks = {
...
static rosidl_message_type_support_t _RemoveMarker_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RemoveMarker_Request__callbacks,
...
{
  return &marker_interfacing::srv::typesupport_fastrtps_cpp::_RemoveMarker_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const marker_interfacing::srv::RemoveMarker_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<marker_interfacing::srv::RemoveMarker_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RemoveMarker_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const marker_interfacing::srv::RemoveMarker_Response *>(
...
static size_t _RemoveMarker_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RemoveMarker_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RemoveMarker_Response__callbacks = {
  "marker_interfacing::srv",
...
static rosidl_message_type_support_t _RemoveMarker_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RemoveMarker_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &marker_interfacing::srv::typesupport_fastrtps_cpp::_RemoveMarker_Response__handle;
}
...
static service_type_support_callbacks_t _RemoveMarker__callbacks = {
  "marker_interfacing::srv",
  "RemoveMarker",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marker_interfacing, srv, RemoveMarker_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marker_interfacing, srv, RemoveMarker_Response)(),
...
static rosidl_service_type_support_t _RemoveMarker__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RemoveMarker__callbacks,
...
{
  return &marker_interfacing::srv::typesupport_fastrtps_cpp::_RemoveMarker__handle;
}
