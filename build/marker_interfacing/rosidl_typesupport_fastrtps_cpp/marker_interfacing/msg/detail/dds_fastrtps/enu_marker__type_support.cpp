...
#include "marker_interfacing/msg/detail/enu_marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const marker_interfacing::msg::ENUMarker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<marker_interfacing::msg::ENUMarker *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ENUMarker__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const marker_interfacing::msg::ENUMarker *>(
...
static size_t _ENUMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ENUMarker(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ENUMarker__callbacks = {
...
static rosidl_message_type_support_t _ENUMarker__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ENUMarker__callbacks,
...
{
  return &marker_interfacing::msg::typesupport_fastrtps_cpp::_ENUMarker__handle;
}
