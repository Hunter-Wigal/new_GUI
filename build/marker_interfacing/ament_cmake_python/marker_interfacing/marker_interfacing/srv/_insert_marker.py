...
class Metaclass_InsertMarker_Request(type):
    """Metaclass of message 'InsertMarker_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__insert_marker__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__insert_marker__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__insert_marker__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__insert_marker__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__insert_marker__request
...
class InsertMarker_Request(metaclass=Metaclass_InsertMarker_Request):
    """Message class 'InsertMarker_Request'."""
...
class Metaclass_InsertMarker_Response(type):
    """Metaclass of message 'InsertMarker_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__insert_marker__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__insert_marker__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__insert_marker__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__insert_marker__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__insert_marker__response
...
class InsertMarker_Response(metaclass=Metaclass_InsertMarker_Response):
    """Message class 'InsertMarker_Response'."""
...
class Metaclass_InsertMarker(type):
    """Metaclass of service 'InsertMarker'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'marker_interfacing.srv.InsertMarker')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__insert_marker

            from marker_interfacing.srv import _insert_marker
            if _insert_marker.Metaclass_InsertMarker_Request._TYPE_SUPPORT is None:
                _insert_marker.Metaclass_InsertMarker_Request.__import_type_support__()
            if _insert_marker.Metaclass_InsertMarker_Response._TYPE_SUPPORT is None:
                _insert_marker.Metaclass_InsertMarker_Response.__import_type_support__()


class InsertMarker(metaclass=Metaclass_InsertMarker):
    from marker_interfacing.srv._insert_marker import InsertMarker_Request as Request
    from marker_interfacing.srv._insert_marker import InsertMarker_Response as Response
