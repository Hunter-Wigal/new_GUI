...
static const _PlanHomeMarker_Request_type_support_symbol_names_t _PlanHomeMarker_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marker_interfacing, srv, PlanHomeMarker_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marker_interfacing, srv, PlanHomeMarker_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, marker_interfacing, srv, PlanHomeMarker_Request)() {
  return &::marker_interfacing::srv::rosidl_typesupport_c::PlanHomeMarker_Request_message_type_support_handle;
}
...
static const _PlanHomeMarker_Response_type_support_symbol_names_t _PlanHomeMarker_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marker_interfacing, srv, PlanHomeMarker_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marker_interfacing, srv, PlanHomeMarker_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, marker_interfacing, srv, PlanHomeMarker_Response)() {
  return &::marker_interfacing::srv::rosidl_typesupport_c::PlanHomeMarker_Response_message_type_support_handle;
}
...
static const _PlanHomeMarker_type_support_symbol_names_t _PlanHomeMarker_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marker_interfacing, srv, PlanHomeMarker)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marker_interfacing, srv, PlanHomeMarker)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, marker_interfacing, srv, PlanHomeMarker)() {
  return &::marker_interfacing::srv::rosidl_typesupport_c::PlanHomeMarker_service_type_support_handle;
}
