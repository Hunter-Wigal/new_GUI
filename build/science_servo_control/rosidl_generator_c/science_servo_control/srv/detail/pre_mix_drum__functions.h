...
#ifndef SCIENCE_SERVO_CONTROL__SRV__DETAIL__PRE_MIX_DRUM__FUNCTIONS_H_
#define SCIENCE_SERVO_CONTROL__SRV__DETAIL__PRE_MIX_DRUM__FUNCTIONS_H_
...
/// Initialize srv/PreMixDrum message.
/**
...
/// Finalize srv/PreMixDrum message.
/**
...
/// Create srv/PreMixDrum message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * science_servo_control__srv__PreMixDrum_Request__init().
...
/// Destroy srv/PreMixDrum message.
/**
 * It calls
 * science_servo_control__srv__PreMixDrum_Request__fini()
...
/// Check for srv/PreMixDrum message equality.
/**
...
/// Initialize array of srv/PreMixDrum messages.
/**
...
/// Finalize array of srv/PreMixDrum messages.
/**
 * It calls
 * science_servo_control__srv__PreMixDrum_Request__fini()
...
/// Create array of srv/PreMixDrum messages.
/**
 * It allocates the memory for the array and calls
 * science_servo_control__srv__PreMixDrum_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PreMixDrum messages.
/**
 * It calls
 * science_servo_control__srv__PreMixDrum_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PreMixDrum message array equality.
/**
...
/// Copy an array of srv/PreMixDrum messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * science_servo_control__srv__PreMixDrum_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_science_servo_control
...
/**
 * It calls
 * science_servo_control__srv__PreMixDrum_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_science_servo_control
...
/**
 * It allocates the memory for the array and calls
 * science_servo_control__srv__PreMixDrum_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_science_servo_control
...
/**
 * It calls
 * science_servo_control__srv__PreMixDrum_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SCIENCE_SERVO_CONTROL__SRV__DETAIL__PRE_MIX_DRUM__FUNCTIONS_H_
