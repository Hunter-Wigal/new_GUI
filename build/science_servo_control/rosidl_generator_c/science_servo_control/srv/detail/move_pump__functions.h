...
#ifndef SCIENCE_SERVO_CONTROL__SRV__DETAIL__MOVE_PUMP__FUNCTIONS_H_
#define SCIENCE_SERVO_CONTROL__SRV__DETAIL__MOVE_PUMP__FUNCTIONS_H_
...
/// Initialize srv/MovePump message.
/**
...
/// Create srv/MovePump message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * science_servo_control__srv__MovePump_Request__init().
...
/// Destroy srv/MovePump message.
/**
 * It calls
 * science_servo_control__srv__MovePump_Request__fini()
...
/// Check for srv/MovePump message equality.
/**
...
/// Initialize array of srv/MovePump messages.
/**
...
/// Finalize array of srv/MovePump messages.
/**
 * It calls
 * science_servo_control__srv__MovePump_Request__fini()
...
/// Create array of srv/MovePump messages.
/**
 * It allocates the memory for the array and calls
 * science_servo_control__srv__MovePump_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MovePump messages.
/**
 * It calls
 * science_servo_control__srv__MovePump_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MovePump message array equality.
/**
...
/// Copy an array of srv/MovePump messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * science_servo_control__srv__MovePump_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_science_servo_control
...
/**
 * It calls
 * science_servo_control__srv__MovePump_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_science_servo_control
...
/**
 * It allocates the memory for the array and calls
 * science_servo_control__srv__MovePump_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_science_servo_control
...
/**
 * It calls
 * science_servo_control__srv__MovePump_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SCIENCE_SERVO_CONTROL__SRV__DETAIL__MOVE_PUMP__FUNCTIONS_H_
