...
#ifndef SCIENCE_SERVO_CONTROL__SRV__MOVE_LINEAR_ACTUATOR_H_
#define SCIENCE_SERVO_CONTROL__SRV__MOVE_LINEAR_ACTUATOR_H_
...
#endif  // SCIENCE_SERVO_CONTROL__SRV__MOVE_LINEAR_ACTUATOR_H_
