...
static const _RebootDrum_Request_type_support_symbol_names_t _RebootDrum_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, science_servo_control, srv, RebootDrum_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, science_servo_control, srv, RebootDrum_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, science_servo_control, srv, RebootDrum_Request)() {
  return &::science_servo_control::srv::rosidl_typesupport_c::RebootDrum_Request_message_type_support_handle;
}
...
static const _RebootDrum_Response_type_support_symbol_names_t _RebootDrum_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, science_servo_control, srv, RebootDrum_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, science_servo_control, srv, RebootDrum_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, science_servo_control, srv, RebootDrum_Response)() {
  return &::science_servo_control::srv::rosidl_typesupport_c::RebootDrum_Response_message_type_support_handle;
}
...
static const _RebootDrum_type_support_symbol_names_t _RebootDrum_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, science_servo_control, srv, RebootDrum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, science_servo_control, srv, RebootDrum)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, science_servo_control, srv, RebootDrum)() {
  return &::science_servo_control::srv::rosidl_typesupport_c::RebootDrum_service_type_support_handle;
}
