...
static const _FreeMoveDrum_Request_type_support_symbol_names_t _FreeMoveDrum_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, science_servo_control, srv, FreeMoveDrum_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, science_servo_control, srv, FreeMoveDrum_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, science_servo_control, srv, FreeMoveDrum_Request)() {
  return &::science_servo_control::srv::rosidl_typesupport_c::FreeMoveDrum_Request_message_type_support_handle;
}
...
static const _FreeMoveDrum_Response_type_support_symbol_names_t _FreeMoveDrum_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, science_servo_control, srv, FreeMoveDrum_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, science_servo_control, srv, FreeMoveDrum_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, science_servo_control, srv, FreeMoveDrum_Response)() {
  return &::science_servo_control::srv::rosidl_typesupport_c::FreeMoveDrum_Response_message_type_support_handle;
}
...
static const _FreeMoveDrum_type_support_symbol_names_t _FreeMoveDrum_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, science_servo_control, srv, FreeMoveDrum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, science_servo_control, srv, FreeMoveDrum)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, science_servo_control, srv, FreeMoveDrum)() {
  return &::science_servo_control::srv::rosidl_typesupport_c::FreeMoveDrum_service_type_support_handle;
}
