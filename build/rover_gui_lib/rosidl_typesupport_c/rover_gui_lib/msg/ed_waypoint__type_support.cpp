...
static const _EDWaypoint_type_support_symbol_names_t _EDWaypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_gui_lib, msg, EDWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_gui_lib, msg, EDWaypoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rover_gui_lib, msg, EDWaypoint)() {
  return &::rover_gui_lib::msg::rosidl_typesupport_c::EDWaypoint_message_type_support_handle;
}
