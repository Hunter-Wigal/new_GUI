...
static const _EDWaypointList_type_support_symbol_names_t _EDWaypointList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_gui_lib, msg, EDWaypointList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rover_gui_lib, msg, EDWaypointList)),
  }
};
...
{
  return &::rover_gui_lib::msg::rosidl_typesupport_cpp::EDWaypointList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rover_gui_lib, msg, EDWaypointList)() {
  return get_message_type_support_handle<rover_gui_lib::msg::EDWaypointList>();
}
