...
from new_gui.urc_gui_common.widgets import MapPoint, MapViewer, HLine
from new_gui.urc_gui_common.helpers.file_helper import file_basenames
from new_gui.urc_gui_common.helpers.internet import can_access_internet
from new_gui.urc_gui_common.helpers.validator import Validators, red_if_unacceptable, valid_entries
...
### route optimizer ##########################################################
	...
	def optimize_route_handler(self):
		def failed_to_reorder_markers():
			# TODO: popup box
			self.loggernode.warn('Failed to reorder markers!')
