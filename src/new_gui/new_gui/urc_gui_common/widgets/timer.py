...
from new_gui.urc_gui_common.widgets.ui_python.set_time_dialog import Ui_timer_dialog
from new_gui.urc_gui_common.widgets.ui_python.timer_widget import Ui_Timer
