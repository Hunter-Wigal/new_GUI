...
from gui_window.urc_gui_common.widgets import MapPoint, MapViewer, HLine
from gui_window.urc_gui_common.helpers.file_helper import file_basenames
from gui_window.urc_gui_common.helpers.internet import can_access_internet
from gui_window.urc_gui_common.helpers.validator import Validators, red_if_unacceptable, valid_entries
from gui_window.urc_gui_common.helpers.route_optimization import optimize_route, algorithms, cost_functions
from gui_window.urc_gui_common.ui_python.autonomy_edit_dialog import AutonomyEditMarkerDialog
from gui_window.urc_gui_common.ui_python.optimization_dialog import Ui_optimization_dialog
from gui_window.urc_gui_common import tile_scraper
...
class MapTab(QWidget):
	...
	def select_map_server(self, map_server: tile_scraper.MapServer):
		try:
			...
			rclpy.Node.get_logger().ERROR(err_msg)
			return
